    ...
    <div className="login-wrap">
      <div className="login-hero">
        ...
        <ul className="hero-list">
          <li>
            <b>9 ролей</b>, делегирование полномочий, отпуска с автопереназначением
          ...
          <li>
            <b>Демо-режим. Работает без БД. Новые и измененные данные после перезагрузки приходят к первоначльному виду</b>
          </li>
        </ul>
