/**
 * Моковые данные для тестирования и демо-режима
...
export function buildMockData() {
  const D = (off: number): string => iso(addDays(new Date(), off));
  const now = Date.now();
  ...
  const settings: Settings = { archiveMonths: 6 };
  ...
  // ПРИМЕЧАНИЕ: В production пароли должны храниться в хешированном виде (bcrypt/argon2)
  // Для демо-режина используется token-based аутентификация без паролей
  const employees: Employee[] = [
    { id: "sergey.adminov", last: "Админов", first: "Сергей", email: "sergey.adminov", pass: undefined, position: "Администратор системы", departments: [{ deptId: "d_okk", primary: true }], roles: ["admin"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "101", tab: "1001", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "aleksey.gendirov", last: "Гендиров", first: "Алексей", email: "aleksey.gendirov", pass: undefined, position: "Генеральный директор", departments: [], roles: ["director"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "102", tab: "1002", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 3 },
    { id: "erik.ekonomistov", last: "Экономистов", first: "Эрик", email: "erik.ekonomistov", pass: undefined, position: "Главный экономист", departments: [{ deptId: "d_management", primary: true }], roles: ["economist"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "103", tab: "1003", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "ivan.konstruktorov", last: "Конструкторов", first: "Иван", email: "ivan.konstruktorov", pass: undefined, position: "Главный конструктор КБ «ЛА»", departments: [], roles: ["kb_chief", "executor"], kbIds: ["kb_la"], headDeptIds: [], phone: "+7 900 000-00-00", extension: "104", tab: "1004", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 5 },
    { id: "petr.konstruktorov", last: "Конструкторов", first: "Пётр", email: "petr.konstruktorov", pass: undefined, position: "Главный конструктор КБ АД", departments: [], roles: ["kb_chief", "executor"], kbIds: ["kb_ad"], headDeptIds: [], phone: "+7 900 000-00-00", extension: "105", tab: "1005", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
    { id: "olga.personalova", last: "Персоналова", first: "Ольга", email: "olga.personalova", pass: undefined, position: "Руководитель отдела управления персоналом", departments: [{ deptId: "d_hr", primary: true }], roles: ["hr", "head", "executor"], kbIds: [], headDeptIds: ["d_hr"], phone: "+7 900 000-00-00", extension: "106", tab: "1006", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "mikhail.otdelov", last: "Отделов", first: "Михаил", email: "mikhail.otdelov", pass: undefined, position: "Начальник отдела аэродинамики", departments: [{ deptId: "d_aero", primary: true }], roles: ["head", "executor", "project_lead"], kbIds: [], headDeptIds: ["d_aero", "d_comp"], phone: "+7 900 000-00-00", extension: "107", tab: "1007", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 4 },
    { id: "kirill.proektov", last: "Проектов", first: "Кирилл", email: "kirill.proektov", pass: undefined, position: "Ответственный по проекту", departments: [{ deptId: "d_aero", primary: true }], roles: ["project_lead", "executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "116", tab: "1016", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "nikolay.managerov", last: "Менеджеров", first: "Николай", email: "nikolay.managerov", pass: undefined, position: "Менеджер проектов", departments: [{ deptId: "d_av1", primary: true }], roles: ["project_manager", "executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "117", tab: "1017", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 6 },
    { id: "e_okk_head", last: "Окков", first: "Олег", email: "okk.head", pass: undefined, position: "Руководитель отдела контроля качества", departments: [{ deptId: "d_okk", primary: true }], roles: ["head", "executor"], kbIds: [], headDeptIds: ["d_okk"], phone: "+7 900 000-00-00", extension: "201", tab: "2001", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "e_okk_spec", last: "Специалистов", first: "Сергей", email: "okk.spec", pass: undefined, position: "Специалист по контролю качества", departments: [{ deptId: "d_okk", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "202", tab: "2002", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
    { id: "isaev", last: "Исаев", first: "Роман", email: "isaev", pass: undefined, position: "Инженер-аэродинамик", departments: [{ deptId: "d_aero", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "118", tab: "1018", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 3 },
    { id: "e_gromov", last: "Громов", first: "Сергей", email: "gromov", pass: undefined, position: "Начальник отдела прочности", departments: [{ deptId: "d_strla", primary: true }], roles: ["head", "executor", "project_lead"], kbIds: [], headDeptIds: ["d_strla"], phone: "+7 900 000-00-00", extension: "108", tab: "1008", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "e_ilina", last: "Ильина", first: "Анна", email: "ilina", pass: undefined, position: "Ведущий инженер-компоновщик", departments: [{ deptId: "d_comp", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "109", tab: "1009", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "e_krylov", last: "Крылов", first: "Виктор", email: "krylov", pass: undefined, position: "Начальник отдела газодинамики", departments: [{ deptId: "d_gas", primary: true }], roles: ["head", "executor", "project_lead"], kbIds: [], headDeptIds: ["d_gas"], phone: "+7 900 000-00-00", extension: "110", tab: "1010", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
    { id: "e_medvedev", last: "Медведев", first: "Павел", email: "medvedev", pass: undefined, position: "Начальник отдела прочности двигателей", departments: [{ deptId: "d_stren", primary: true }], roles: ["head", "executor", "project_lead"], kbIds: [], headDeptIds: ["d_stren"], phone: "+7 900 000-00-00", extension: "111", tab: "1011", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "e_orlova", last: "Орлова", first: "Елена", email: "orlova", pass: undefined, position: "Начальник отдела САУ", departments: [{ deptId: "d_sau", primary: true }], roles: ["head", "executor"], kbIds: [], headDeptIds: ["d_sau"], phone: "+7 900 000-00-00", extension: "112", tab: "1012", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "e_morozov", last: "Морозов", first: "Константин", email: "morozov", pass: undefined, position: "Ведущий инженер", departments: [{ deptId: "d_aero", primary: true }], roles: ["project_lead", "executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "116", tab: "1016", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 5 },
    { id: "e_zaitsev", last: "Зайцев", first: "Алексей", email: "zaitsev", pass: undefined, position: "Инженер по прочности", departments: [{ deptId: "d_strla", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "119", tab: "1019", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
    { id: "e_frolova", last: "Фролова", first: "Дарья", email: "frolova", pass: undefined, position: "Инженер-расчётчик", departments: [{ deptId: "d_strla", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "120", tab: "1020", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "e_tolka", last: "Толкачёва", first: "Ирина", email: "tolkacheva", pass: undefined, position: "Инженер-конструктор", departments: [{ deptId: "d_comp", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "121", tab: "1021", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "e_gusev", last: "Гусев", first: "Максим", email: "gusev", pass: undefined, position: "Инженер по весам", departments: [{ deptId: "d_comp", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "122", tab: "1022", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "e_tihonov", last: "Тихонов", first: "Егор", email: "tihonov", pass: undefined, position: "Инженер-газодинамик", departments: [{ deptId: "d_gas", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "123", tab: "1023", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 0 },
    { id: "e_melnik", last: "Мельник", first: "Светлана", email: "melnik", pass: undefined, position: "Инженер по ресурсу", departments: [{ deptId: "d_stren", primary: true }, { deptId: "d_gas", primary: false }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "124", tab: "1024", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 3 },
    { id: "e_koval", last: "Ковальчук", first: "Пётр", email: "kovalchuk", pass: undefined, position: "Инженер-программист САУ", departments: [{ deptId: "d_sau", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "125", tab: "1025", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
    { id: "e_somova", last: "Сомова", first: "Екатерина", email: "somova", pass: undefined, position: "Инженер-конструктор", departments: [{ deptId: "d_comp", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "126", tab: "1026", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 1 },
    { id: "e_av1_head", last: "Радионов", first: "Андрей", email: "av1.head", pass: undefined, position: "Начальник ОБРЭО", departments: [{ deptId: "d_av1", primary: true }], roles: ["head", "executor"], kbIds: [], headDeptIds: ["d_av1"], phone: "+7 900 000-00-00", extension: "128", tab: "1028", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 4 },
    { id: "e_anokhin", last: "Анохин", first: "Сергей", email: "anokhin", pass: undefined, position: "Инженер по ОБРЭО", departments: [{ deptId: "d_av1", primary: true }], roles: ["executor"], kbIds: [], headDeptIds: [], phone: "+7 900 000-00-00", extension: "127", tab: "1027", notif: { deadlineEmail: true, overdueDigest: false, commentSub: true }, failed: 0, lockUntil: 0, fired: false, passwordHistory: [], photo: null, delegatedTasksCount: 2 },
  ];
  ...
  const tasks: Task[] = [
    ...
    T("t24", "Расчёт газодинамики двигателя", "p_rd900", ["petr.konstruktorov"], 30, -12, 20, "new", "high", "Расчёт параметров рабочего процесса."),
    ...
    T("t28", "Контроль качества сборки", "p_lm24", ["e_okk_head"], 16, -6, 4, "new", "high", "Входной контроль комплектующих."),
    T("t29", "Проверка документации", "p_lm24", ["e_okk_spec"], 12, -4, 2, "new", "mid", "Проверка конструкторской документации."),
  ...
  const regRequests = [
    { id: "rg1", first: "Олег", last: "Новиков", email: "novikov", pass: undefined, status: "pending", ts: now - 3600000 * 26 },
  ];
